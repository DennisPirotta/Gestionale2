...
class HistoryExchangeData extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'exchange:history';
     ...
     * @var string
     */
    protected $description = 'Load last year data from Exchange API';
    ...
    private function storeData($symbol): void
    {
        ...
        $response = $client->request('GET',config('constants.api.exchange.endpoint'),['query' => [
            ...
            'interval' => '4h',
            'symbol' => $symbol,
            'start_date' => Carbon::today()->firstOfYear()->format('Y-m-d H:m:s'),
